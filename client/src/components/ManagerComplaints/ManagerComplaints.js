...
import TrainComplaints from './TrainComplaints.js'; 
import StationComplaints from './StationComplaints.js'; 
import ParcelComplaints from './ParcelComplaints'; 
import MiscellaneousComplaints from './MiscellaneousComplaints';
import './Complaints.css';

const ManagerComplaints=(props) =>{
